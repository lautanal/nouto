...
def prices(week_nr, day_id, noutolaji, city, p_extra):
    if (noutolaji == "1"):
        hinnat = [59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59]
    elif (noutolaji == "2"):
        hinnat = [99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99]
    elif(noutolaji == "3"):
        hinnat = [149,149,149,149,149,149,149,149,149,149,149,149,149,149,149,149,149,149,149,149]
    for i in range(20):
        hinnat[i] = hinnat[i] + p_extra

# Hintalisä tai alennus
...
# Ei lisämaksua jos muita noutoja samalta alueella
